...
public final class Constants {
  ...
  public static final class DrivetrainConstants {
    ...
    public static final double kCountsPerMotorShaftRev = 12.0; // Encoder(?) counts per motor shaft revolution
    public static final double kCountsPerRevolution = kCountsPerMotorShaftRev * kGearRatio; // 585.0 counts per wheel revolution
